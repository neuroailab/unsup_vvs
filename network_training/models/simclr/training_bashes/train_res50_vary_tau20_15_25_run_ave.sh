...
MODEL_DIR=gs://cx_visualmaster/simclr_vary_tau_20_15_25_rm
...
python run.py --train_mode=pretrain \
  ...
  --num_transforms=4 --adjust_temp=True --adjust_temp_params=0.016,0.016,0.15,0.25 --rn_avg_for_temp=True
