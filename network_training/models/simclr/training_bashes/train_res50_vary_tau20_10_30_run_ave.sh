...
MODEL_DIR=gs://cx_visualmaster/simclr_vary_tau_20_10_30_rm
...
python run.py --train_mode=pretrain \
  ...
  --num_transforms=4 --adjust_temp=True --adjust_temp_params=0.033,0.033,0.10,0.30 --rn_avg_for_temp=True
