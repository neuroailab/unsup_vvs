...
MODEL_DIR=gs://cx_visualmaster/simclr_vary_tau_blr_aug4_fx
...
python run.py --train_mode=pretrain \
  ...
  --num_transforms=4 --adjust_temp=True

FIT_MODEL_DIR=gs://cx_visualmaster/simclr_vary_tau_fit_blr_aug4_fx
