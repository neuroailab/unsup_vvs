...
def build_model_fn(model, num_classes, num_train_examples):
  ...
  def model_fn(features, labels, mode, params=None):
    ...
    if FLAGS.train_mode == 'pretrain':
      ...
      loss_func = obj_lib.add_contrastive_loss
      if FLAGS.num_transforms > 2:
        loss_func = obj_lib.add_contrastive_loss_multi_aug
      contrast_loss, logits_con, labels_con = loss_func(
          hiddens_proj,
