test_str="
python train_combinet.py --expId tpu_inst_resnet18_b128_3 \
     --dataconfig dataset_config_image.cfg --valinum 782 --batchsize 128 --valbatchsize 64 --label_norm 1 --nport 27001 \
     --withclip 0 --no_shuffle 0 --init_lr 0.03 --fre_filter 10009 --pathconfig instance_resnet18.cfg \
     ...
     --tpu_flag 1 --tpu_name cx-cbnet-8 --tpu_task instance_task --inst_lbl_pkl ../other_dataset/imagenet/all_label.pkl
"
