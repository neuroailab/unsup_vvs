test_str="
python train_combinet.py --expId tpu_resnet101_mtp02_rd_lc \
    ...
    --tpu_task mean_teacher --weight_decay 5e-5 --tpu_name cx-cbnet-11 --with_feat 0 --tpu_flag 1 \
    --cons_ramp_len 50000 --whichimagenet 13 --withclip 0 \
