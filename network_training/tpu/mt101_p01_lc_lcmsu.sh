...
#fre_filter=100
test_str="
python train_combinet.py --expId tpu_mt101_p01_rdlc_lcmsu \
    --dataconfig dataset_config_image_wun.cfg --batchsize 128 --valinum 400 --init_lr 0.1 \
    --pathconfig mean_teacher_resnet101_block3.cfg --mean_teacher 1 --whichopt 3 --nport 27001 \
    ...
    --ema_zerodb 1 --add_batchname _rp --ignorebname_new 0 --cons_max_value 20 --cons_ramp_len 50000 \
"
