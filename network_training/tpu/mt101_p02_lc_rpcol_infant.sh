...
#fre_filter=100
test_str="
python train_combinet.py --expId tpu_mt101_p02_rdlc_rpcol_infant \
    ...
    --tpu_task mean_teacher --weight_decay 5e-5 --tpu_name m-tpu-11 --with_feat 0 --tpu_flag 1 \
    --cons_ramp_len 50000 --whichimagenet infant_02 --withclip 0 --color_norm 2\
