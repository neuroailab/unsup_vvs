test_str="
python train_combinet.py --expId tpu_resnet101_mtp20_rd_lc_infant_2 \
    ...
    --tpu_task mean_teacher --weight_decay 5e-5 --tpu_name m-tpu-0 --with_feat 0 --tpu_flag 1 \
    --cons_ramp_len 50000 --whichimagenet infant_20 --withclip 0 --color_norm 2\
