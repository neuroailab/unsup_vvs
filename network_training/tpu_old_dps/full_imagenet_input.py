...
class ImageNetInput(object):
  ...
  def __init__(self, is_training, data_dir, num_cores=8, std=True, depth_imn_tl=0, l_channel=0):
    ...
    self.std = std
    self.depth_imn_tl = depth_imn_tl
  ...
  def dataset_parser(self, value):
    ...
    image = self.image_preprocessing_fn(
        ...
        std=self.std,
        depth_imn_tl = self.depth_imn_tl,
  ...
  def input_fn(self, params):
    ...
    print("output of data_provider function")
    print(images)
    print(labels)
