...
#fre_filter=100
test_str="
python train_combinet.py --expId tpu_mt101_p05_rdlc_rpcol_sl \
    --dataconfig dataset_config_image_wun.cfg --batchsize 128 --valinum 400 --init_lr 0.01 --target_lr 0.0025 \
