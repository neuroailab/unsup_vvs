test_str="
python train_combinet.py --expId tpu_inst_resnet18_e1 \
     ...
     --tpu_flag 1 --tpu_name cx-cbnet-5 --tpu_task instance_task --inst_lbl_pkl ../other_dataset/imagenet/all_label.pkl
"
