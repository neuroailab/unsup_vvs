test_str="
python train_combinet.py --expId tpu_inst_resnet18_64 \
     --dataconfig dataset_config_image.cfg --valinum 782 --batchsize 256 --valbatchsize 64 --label_norm 1 --nport 27001 \
     --withclip 0 --no_shuffle 0 --init_lr 0.03 --fre_filter 10010 --pathconfig instance_resnet18_64.cfg \
     --global_weight_decay 1e-4 --with_feat 0 --color_norm 1 --fre_valid 10010 --instance_task 1 --whichopt 0 \
