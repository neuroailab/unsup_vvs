...
do
    python fit_neural_data.py --gpu ${gpu} \
        ...
        --expId cate_e69_tr_bwd_sp${split}_${rep} \
        --v1v2_folder /mnt/fs4/chengxuz/v1v2_related/tfrs_txt_rand/ \
        --which_split split_${split}

    :"
    python fit_neural_data.py --gpu ${gpu} \
        --load_setting_func v1v2_setting.cate_res18_v1v2_bbwd_to_be_filled \
        --expId cate_e69_tr_bbwd_sp${split}_${rep} \
        --v1v2_folder /mnt/fs4/chengxuz/v1v2_related/tfrs_txt_rand/ \
        --which_split split_${split}
    ...
    do
        python fit_neural_data.py --gpu ${gpu} \
            ...
            --expId cate_e${layer}_tr_sp${split}_${rep} \
            --v1v2_folder /mnt/fs4/chengxuz/v1v2_related/tfrs_txt_rand/ \
            --which_split split_${split}
    done
    "
