...
do
    python fit_neural_data.py \
        ...
        --expId res18_mtp03_inst_infant_wf_${which_split} --gpu 0 \
        ...
        --mean_teacher 1 \
        --ckpt_file /home/chengxuz/tpu_ckpts/res18_mt_p03_inst_infant/model.ckpt-40041 \
        --which_split ${which_split} --train_num_steps 65000
done
